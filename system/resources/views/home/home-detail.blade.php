  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5" >
            ...
            @csrf
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <textarea name="pesan" id="" class="form-control" placeholder="Write your message..." cols="30" rows="10"></textarea>
                </div>
              </div>
              <div class="form-group row">
            ...
            <div class="bg-white p-3 p-md-5">
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block mb-3">
                  ...
                  <span>Jalan Celincing Desa Sukabaru, Kec. Benua Kayong.</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Phone:</span><span>+6283125363592</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Email:</span><span>admlna26@gmail.com</span></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="site-section">
      @foreach($list_komen as $komen)
        <div class="container" style="border: 1px solid rgb(219, 219, 219); border-radius: 15px; padding: 30px;">
          <div class="row">
            <div class="col-md 12">
              <div class="form-group">
                <h4 style="opacity: 0.7;">{{$komen->nama}}</h4>
                <p style="opacity: 0.5;">{{ $komen->created_at->diffForHumans() }}</p>
                <hr>
                <p>{{$komen->pesan}}</p>
              </div>
            </div>
